// Package version groups utility functions to query version information.
package version
...
// GetAPIVersion get the SoapySDR library API version as a string. The format of the version string is major.minor.increment
//
...
// GetLibVersion gets the library version and build information string. The format of the version string is major.minor.patch-buildInfo.
